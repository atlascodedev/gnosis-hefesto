...
export interface MaterialTableWithIconsProps<T extends {}>
  extends MaterialTableProps<T> {}

const MaterialTableWithIcons = <T extends {} = {}>(
  props: MaterialTableWithIconsProps<T>
) => {
  return <MaterialTable icons={tableIcons as any} {...props} />;
};
