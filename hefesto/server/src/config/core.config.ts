export default {
  ...
  ADONIS_ROOT_FOLDER: "adonis",
  ADONIS_FULL_IMAGE_FOLDER: "gallery",
  ADONIS_THUMBNAIL_IMAGE_FOLDER: "gallery_thumbnail",
  ADONIS_THUMBNAIL_BLUR_IMAGE_FOLDER: "gallery_thumbnail_blur",
